...
const options = reactive({
  ...
  add: {
    show: true,
    api: staticText.save,
    auth: ['caoliu:text:save']
  },
  edit: {
    show: true,
    api: staticText.update,
    auth: ['caoliu:text:update']
  },
  delete: {
    show: true,
    api: staticText.deletes,
    auth: ['caoliu:text:delete'],
    realApi: staticText.realDeletes,
    realAuth: ['caoliu:text:realDeletes']
  },
  recovery: {
    show: true,
    api: staticText.recoverys,
    auth: ['caoliu:text:recovery']
  },
...
<script> export default { name: 'caoliu:text' } </script>
