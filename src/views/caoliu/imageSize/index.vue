...
const options = reactive({
  ...
  add: {
    ...
    auth: ['caoliu:imageSize:save']
  },
  edit: {
    show: true,
    api: staticImageSize.update,
    auth: ['caoliu:imageSize:update']
  },
  delete: {
    show: true,
    api: staticImageSize.deletes,
    auth: ['caoliu:imageSize:delete'],
    realApi: staticImageSize.realDeletes,
    realAuth: ['caoliu:imageSize:realDeletes']
  },
  recovery: {
    show: true,
    api: staticImageSize.recoverys,
    auth: ['caoliu:imageSize:recovery']
  },
...
<script> export default { name: 'caoliu:imageSize' } </script>