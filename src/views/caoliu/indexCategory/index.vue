...
const options = reactive({
  ...
  add: {
    ...
    auth: ['caoliu:indexCategory:save']
  },
  edit: {
    show: true,
    api: staticIndexCategory.update,
    auth: ['caoliu:indexCategory:update']
  },
  delete: {
    show: true,
    api: staticIndexCategory.deletes,
    auth: ['caoliu:indexCategory:delete'],
    realApi: staticIndexCategory.realDeletes,
    realAuth: ['caoliu:indexCategory:realDeletes']
  },
  recovery: {
    show: true,
    api: staticIndexCategory.recoverys,
    auth: ['caoliu:indexCategory:recovery']
  },
...
<script> export default { name: 'caoliu:indexCategory' } </script>