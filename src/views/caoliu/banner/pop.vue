  ...
  <div>
    <a-alert type="info" :show-icon="false">
      <a-space>
        ...
        <icon-notification/>
        <a-typography-text>本广告位图片标准比例：400(宽) x 450(高)</a-typography-text>
      </a-space>
    </a-alert>
...
const options = reactive({
  ...
  add: {
    ...
    auth: ['caoliu:pop:save']
  },
  edit: {
    show: true,
    api: staticBanner.update,
    auth: ['caoliu:pop:update']
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ['caoliu:pop:delete'],
    realApi: staticBanner.realDeletes,
    realAuth: ['caoliu:pop:realDeletes']
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ['caoliu:pop:recovery']
  },
...
<script> export default { name: 'caoliu:pop' } </script>