...
const options = reactive({
  ...
  add: {
    ...
    auth: ['caoliu:banner:save']
  },
  edit: {
    show: true,
    api: staticBanner.update,
    auth: ['caoliu:banner:update']
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ['caoliu:banner:delete'],
    realApi: staticBanner.realDeletes,
    realAuth: ['caoliu:banner:realDeletes']
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ['caoliu:banner:recovery']
  },
...
<script> export default { name: 'caoliu:banner' } </script>