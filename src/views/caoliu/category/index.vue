...
const options = reactive({
  ...
  add: {
    ...
    auth: ['caoliu:category:save']
  },
  edit: {
    show: true,
    api: staticCategory.update,
    auth: ['caoliu:category:update']
  },
  delete: {
    show: true,
    api: staticCategory.deletes,
    auth: ['caoliu:category:delete'],
    realApi: staticCategory.realDeletes,
    realAuth: ['caoliu:category:realDeletes']
  },
  recovery: {
    show: true,
    api: staticCategory.recoverys,
    auth: ['caoliu:category:recovery']
  }
})
...
<script> export default { name: 'caoliu:category' } </script>