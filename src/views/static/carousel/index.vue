...
const options = reactive({
  ...
  add: {
    ...
    auth: ['static:carousel:save']
  },
  edit: {
    show: true,
    api: staticCarousel.update,
    auth: ['static:carousel:update']
  },
  delete: {
    show: true,
    api: staticCarousel.deletes,
    auth: ['static:carousel:delete'],
    realApi: staticCarousel.realDeletes,
    realAuth: ['static:carousel:realDeletes']
  },
  recovery: {
    show: true,
    api: staticCarousel.recoverys,
    auth: ['static:carousel:recovery']
  },
...
<script> export default { name: 'static:carousel' } </script>