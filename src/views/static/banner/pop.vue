...
const options = reactive({
  ...
  add: {
    ...
    auth: ['static:pop:save']
  },
  edit: {
    show: true,
    api: staticBanner.update,
    auth: ['static:pop:update']
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ['static:pop:delete'],
    realApi: staticBanner.realDeletes,
    realAuth: ['static:pop:realDeletes']
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ['static:pop:recovery']
  },
...
<script> export default {name: 'static:pop'} </script>