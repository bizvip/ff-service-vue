...
const options = reactive({
  ...
  add: {
    ...
    auth: ['static:fixed:save']
  },
  edit: {
    show: true,
    api: staticBanner.update,
    auth: ['static:fixed:update']
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ['static:fixed:delete'],
    realApi: staticBanner.realDeletes,
    realAuth: ['static:fixed:realDeletes']
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ['static:fixed:recovery']
  },
...
<script> export default {name: 'static:fixed'} </script>