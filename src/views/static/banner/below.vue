...
const options = reactive({
  ...
  add: {
    ...
    auth: ['static:below:save']
  },
  edit: {
    show: true,
    api: staticBanner.update,
    auth: ['static:below:update']
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ['static:below:delete'],
    realApi: staticBanner.realDeletes,
    realAuth: ['static:below:realDeletes']
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ['static:below:recovery']
  },
...
<script> export default { name: 'static:below' } </script>