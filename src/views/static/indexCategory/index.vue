...
const options = reactive({
  ...
  add: {
    ...
    auth: ['static:indexCategory:save']
  },
  edit: {
    show: true,
    api: staticIndexCategory.update,
    auth: ['static:indexCategory:update']
  },
  delete: {
    show: true,
    api: staticIndexCategory.deletes,
    auth: ['static:indexCategory:delete'],
    realApi: staticIndexCategory.realDeletes,
    realAuth: ['static:indexCategory:realDeletes']
  },
  recovery: {
    show: true,
    api: staticIndexCategory.recoverys,
    auth: ['static:indexCategory:recovery']
  },
...
<script> export default { name: 'static:indexCategory' } </script>