<template>
    <div>
        <a-alert closable style="clear: both">点击表格任意行可以查看该条记录详情</a-alert>
                    ...
                    <div class="arco-descriptions-body">
                        <table class="arco-descriptions-table">
                            ...
                            <tr class="arco-descriptions-row">
                                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">请求路由
                                </td>
                                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">
                                    {{ currentRow?.router }}
                                </td>
                            </tr>
                            <tr class="arco-descriptions-row">
                                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">操作用户
                                </td>
                                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">
                                    {{ currentRow?.username }}
                                </td>
                            ...
                            <tr class="arco-descriptions-row">
                                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">请求方法
                                </td>
                                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">
                                    {{ currentRow?.method }}
                                </td>
                            ...
                            <tr class="arco-descriptions-row">
                                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">响应代码
                                </td>
                                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">
                            ...
                            <tr class="arco-descriptions-row">
                                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">业务名称
                                </td>
                                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">
                            ...
                            <tr class="arco-descriptions-row">
                                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">操作时间
                                </td>
                                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">
                            ...
                            <tr class="arco-descriptions-row">
                                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">用户地点
                                </td>
                                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">
...
const openDetails = (record) => {
  ...
  if (record.request_data.length > 0) {
    currentRow.value.request_data = !/\\\\/g.test(record.request_data) ? formatJson(currentRow.value.request_data) : currentRow.value.request_data.replace(/,/g, ',\n')
  }
  if (record.response_data.length > 0) {
    currentRow.value.response_data = !/\\\\/g.test(record.response_data) ? formatJson(currentRow.value.response_data) : currentRow.value.response_data.replace(/,/g, '\n')
  }
  visible.value = true
}
