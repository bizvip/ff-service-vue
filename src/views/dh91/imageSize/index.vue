...
const options = reactive({
  ...
  add: {
    ...
    auth: ['dh91:imageSize:save']
  },
  edit: {
    show: true,
    api: staticImageSize.update,
    auth: ['dh91:imageSize:update']
  },
  delete: {
    show: true,
    api: staticImageSize.deletes,
    auth: ['dh91:imageSize:delete'],
    realApi: staticImageSize.realDeletes,
    realAuth: ['dh91:imageSize:realDeletes']
  },
  recovery: {
    show: true,
    api: staticImageSize.recoverys,
    auth: ['dh91:imageSize:recovery']
  },
...
<script> export default { name: 'dh91:imageSize' } </script>