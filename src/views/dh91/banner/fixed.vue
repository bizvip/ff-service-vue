...
const options = reactive({
  ...
  add: {
    ...
    auth: ['dh91:fixed:save']
  },
  edit: {
    show: true,
    api: staticBanner.update,
    auth: ['dh91:fixed:update']
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ['dh91:fixed:delete'],
    realApi: staticBanner.realDeletes,
    realAuth: ['dh91:fixed:realDeletes']
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ['dh91:fixed:recovery']
  },
...
<script> export default { name: 'dh91:fixed' } </script>