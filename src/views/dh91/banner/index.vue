...
const options = reactive({
  ...
  add: {
    ...
    auth: ['dh91:banner:save']
  },
  edit: {
    show: true,
    api: staticBanner.update,
    auth: ['dh91:banner:update']
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ['dh91:banner:delete'],
    realApi: staticBanner.realDeletes,
    realAuth: ['dh91:banner:realDeletes']
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ['dh91:banner:recovery']
  },
...
<script> export default { name: 'dh91:banner' } </script>