...
const options = reactive({
  ...
  add: {
    ...
    auth: ['dh91:below:save']
  },
  edit: {
    show: true,
    api: staticBanner.update,
    auth: ['dh91:below:update']
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ['dh91:below:delete'],
    realApi: staticBanner.realDeletes,
    realAuth: ['dh91:below:realDeletes']
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ['dh91:below:recovery']
  },
...
<script> export default { name: 'dh91:below' } </script>