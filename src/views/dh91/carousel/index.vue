...
const options = reactive({
  ...
  add: {
    ...
    auth: ['dh91:carousel:save']
  },
  edit: {
    show: true,
    api: staticCarousel.update,
    auth: ['dh91:carousel:update']
  },
  delete: {
    show: true,
    api: staticCarousel.deletes,
    auth: ['dh91:carousel:delete'],
    realApi: staticCarousel.realDeletes,
    realAuth: ['dh91:carousel:realDeletes']
  },
  recovery: {
    show: true,
    api: staticCarousel.recoverys,
    auth: ['dh91:carousel:recovery']
  },
...
<script> export default { name: 'dh91:carousel' } </script>